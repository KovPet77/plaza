					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Banner hozzáadása</li>
							</ol>
						</nav>
					</div>
					</div>
								...
								<div class="card">
									...
									<form method="POST" action="{{route('store.banner')}}" enctype="multipart/form-data">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="banner_url" required  />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="file" class="form-control" name="banner_image" id="image" required/>
											</div>
										</div>
