					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Banner szerkesztése</li>
							</ol>
						</nav>
					</div>
					</div>
							...
							<div class="col-lg-10">
								<div class="card">
									...
									<form method="POST" action="{{route('update.banner')}}" enctype="multipart/form-data">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Banner neve </h6>
											</div>
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="banner_title" value="{{ $banners->banner_title}}" required  />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="banner_url"  value="{{ $banners->banner_url}}" required  />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
											<img id="showImage" src="{{ asset($banners->banner_image) }}" 
