...
<div class="page-content">
	...
	<div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
                ...
                <div class="card-body">
                    <table class="table" style="background:#212121; font-weight:600;">
                        <tr>
                ...
                <div class="card-body">
                    <table class="table" style="background:#212121; font-weight:600;">
                       ...
                       <tr>
                            <th></th>
                <!-- Itt felugró ablakos megerősítések vannak -->            
                <!-- A felugró ablak kódjai a public mappában a code.js-ben találhatóak -->            
                @if($order->status == 'pending')
                <th><a href="{{ route('pending-confirm', $order->id) }}" class="btn btn-block btn-success" id="confirm">Rendelés megerősítése</a> </th>

                @elseif($order->status == 'confirm')
                <th><a href="{{ route('confirm-processing', $order->id) }}" class="btn btn-block btn-success" id="processing">Rendelés feldolgozásra</a> </th>


                @elseif($order->status == 'processing')
                <th><a href="{{ route('processing-delivered', $order->id) }}" class="btn btn-block btn-success" id="delivered">Rendelés szállításra</a> </th>
