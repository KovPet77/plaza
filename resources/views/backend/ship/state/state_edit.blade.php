...
<div class="page-content"> 
					...
					<div class="breadcrumb-title pe-3">State szerkesztése</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">State szerkesztése</li>
							</ol>
						</nav>
					</div>
					</div>
				...
				<form method="POST" action="{{route('update.state')}}">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<input type="text" class="form-control" name="state_name" required="teszt" value="{{ $state->state_name}}"  />
						</div>
					</div>
