					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">SEO beállítások</li>
							</ol>
						</nav>
					</div>
					</div>
							...
							<div class="col-lg-8">
								<div class="card">
									...
									<form method="POST" action="{{route('seo.setting.update')}}">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Meta Kulcsszó</h6>
											</div>
											<div class="col-sm-9 text-secondary">
