    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Hirdető szerkesztése</li>
            </ol>
        </nav>
    </div>
...
<div class="card">
  <div class="card-body p-4">
      <h5 class="card-title">Hirdető szerkesztése</h5>
      <hr/>

      <form method="POST" action="{{route('update.hirdeto')}}" enctype="multipart/form-data" id="myform">
		 	@csrf
		 	
		 	<input type="hidden" name="id" value="{{$hirdeto->id}}"  />
        ...
        <div class="row">
           ...
           <div class="border border-3 p-4 rounded">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" id="inputProductTitle" value="{{ $hirdeto->name }}" required>na
            </div>
        <div class="mb-3">
                <label for="inputProductTitle" class="form-label">Hirdető email címe</label>
                <input type="email" name="email" class="form-control" id="inputProductTitle" placeholder="Hirdető email címe"  value="{{ $hirdeto->email }}" required>
            </div>
            <div class="mb-3">
                <label for="inputProductTitle" class="form-label">Hirdető telefonszáma</label>
                <input type="text" name="phone" class="form-control" id="inputProductTitle" placeholder="Hirdető telefonszáma"  value="{{ $hirdeto->phone }}" required>
            </div>

        
              <div class="mb-3">
                <label for="inputProductDescription" class="form-label">Hirdetési szöveg</label>
                <textarea id="mytextarea" name="leiras"  required >{{ $hirdeto->leiras }}!</textarea>
              </div>
            <!--
              <div class="mb-3">
             ...
             -->
              ...
              <div class="mb-3">
                ...
                <input class="form-control" name="foto" type="file" id="multiImg" multiple >
