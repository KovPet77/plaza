					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Aktív Eladó Profil</li>
							</ol>
						</nav>
					</div>
					</div>
								...
								<div class="card">
									...
									<form method="POST" action="{{ route('inactive.vendor.approve') }}" >
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" type="email" class="form-control" name="email" value="{{$ActiveVendorDetails->email}}" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
										...
										<div class="row">
											...
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-danger px-4" value="Üzlet Inaktíválása" />
											</div>
										</div>
									</div>
									</form>
