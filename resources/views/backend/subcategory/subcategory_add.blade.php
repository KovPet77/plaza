...
<div class="page-content"> 
					...
					<div class="breadcrumb-title pe-3">Alkategória</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Alkategória hozzáadása</li>
							</ol>
						</nav>
					</div>
					</div>
								...
								<div class="card">
									...
									<form method="POST" action="{{route('store.subcategory')}}" enctype="multipart/form-data">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="subcategory_name" required="teszt"  />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="file" class="form-control" name="subcategory_image" required="teszt"  />
											</div>
										</div>
