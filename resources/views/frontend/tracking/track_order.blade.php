...
<div class="container">
    <article class="card">
        ...
        <div class="card-body">
            <h6>Számla azonosító: {{ $track->invoice_no}}</h6>
            <article class="card">
                <div class="card-body row">
                    <div class="col"> <strong>Rendelés dátuma:</strong> <br>{{ $track->order_date }} </div>


                    <div class="col"> <strong>Megrendelő neve</strong> <br> {{ $track->name }} | <i class="fa fa-phone"></i> {{ $track->phone }}  </div>


                    <div class="col"> <strong>Fizetési mód:</strong> <br> {{ $track->payment_method }} </div>



                    <div class="col"> <strong>Végösszeg:</strong> <br> {{ $track->amount }} Ft. </div>
                </div>
            </article>
            <div class="track">
                ...
                <div class="step active">
                 <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Rendelés függőben</span>
                  </div>

                <div class="step">
                 <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text"> Rendelés megerősítve</span>
                  </div>

                <div class="step"> 
                	<span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">Rendelés feldolgozás alatt </span> 
                </div>


                <div class="step">
                 <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Rendelés szállítás alatt</span>
                  </div>
            ...
            <a href="{{route('user.track.order')}}" class="btn btn-warning" data-abc="true"> <i class="fa fa-chevron-left"></i>Vissza a rendelésekhez</a>
        </div>
    </article>
</div>
