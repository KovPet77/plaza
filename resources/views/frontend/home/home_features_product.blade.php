            ...
            <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                <div class="banner-img style-2">
                    <div class="banner-text">
                        <h2 class="mb-100">Vidd be a természetet az otthonodba!</h2>
                        <a href="" class="btn btn-xs">Vásárlás most<i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="product-img-action-wrap">
            ...
            -->
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <!--
                                        <a href="" class="btn w-100 hover-up"><i class="fi-rs-shopping-cart mr-5"></i>Kosárba</a>
                                        -->
                                    </div>
                                </div>
                                <!--End product Wrap-->
