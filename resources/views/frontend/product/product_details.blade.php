...
<div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html"> {{ $product['category']['category_name'] }}</a> <span></span> {{ $product['subcategory']['subcategory_name'] }} <span>{{ $product->product_name }} </span>
                </div>
            </div>
        </div>
...
<div class="product-price primary-color float-left">
          <span class="current-price text-brand" style="font-size: 30px !important">{{ number_format($product->selling_price, 0, ',', ' ') }} Ft.</span>
 ...
 <div class="product-price primary-color float-left">
             <span class="current-price text-brand" style="font-size: 30px !important">{{ number_format($product->discount_price, 0, ',', ' ') }} Ft.</span>
            <span>
                <span class="save-price font-md color3 ml-15">{{ round($discount) }}% Kedvezmény</span>
               <span class="old-price" style="font-size: 30px !important">{{ number_format($product->selling_price, 0, ',', ' ') }} Ft.</span>
...
<h6>Üzlet: <a href="#"> <span class="text-danger">Pláza tulajdonosa </span> </a></h6>
@else
<h6> Eladó: <a href="{{ url('/pomaz-plaza-' . Str::slug($product['vendor']['name'])) }}"> <span class="text-danger"> {{ $product['vendor']['name'] }} </span></a></h6>
                                        ...
                                        <div class="vendor-logo d-flex mb-30">
                                            ...
                                            <div class="vendor-name ml-15">
                                                ...
                                                @else
                                                 ...
                                                 <h6>
                                                   <h6><a href="{{ url('/pomaz-plaza-' . Str::slug($product['vendor']['name'])) }}"> <span class="text-danger"> {{ $product['vendor']['name'] }} </span></a></h6>
                                                </h6>
                                                @endif
                            ...
                            <div class="col-12">
                                <div class="row related-products">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        ...
                                        <!-- 
                                        VENDOR ID:
                                    <input type="text" name="" value="{{-- $product->vendor_id --}}">
                                        -->
