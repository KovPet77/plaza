...
<head>
    <meta charset="utf-8" />
    <title>Reklámozói Regisztráció</title>
...
@include('frontend.body.header')  
        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span>  <span></span> Reklámozói Regisztráció
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('reklamozoi.regisztracio.harmadiklepes') }}">
        @csrf       
        <div>
        <br>
        	<h5>
        A megadott email címre kiküldtünk egy négyjegyű megerősítő kódot, amivel érvényesítened kell a regisztrációdat!</h5>
        <br>
