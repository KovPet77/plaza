...
<div class="page-content">
			...
			<h4>Ez az eladói profil <span class="text-success">Aktív</span></h4>
			
			@else
			<h4>Ez az eladói profil <span class="text-danger">Inaktív</span></h4>
			<p class="text-danger"><b>Kérlek várd meg míg az admin aktiválja a fiókodat!</b></p>
			@endif
							...
							<div class="card radius-10 bg-gradient-deepblue">
							 <div class="card-body">
								...
								<div class="d-flex align-items-center text-white">
									<p class="mb-0">Összes rendelés</p>
